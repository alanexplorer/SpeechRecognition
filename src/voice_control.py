...
class ASRControl(object):
    ...
    def parse_asr_result(self):
        ...
        if self.decoder.hyp() != None:
            ...
            if seg.word.find("velocidade total") > -1:
                if self.speed == 0.2:
                    self.msg.linear.x = self.msg.linear.x*2
                    self.msg.angular.z = self.msg.angular.z*2
                    self.speed = 0.4
            if seg.word.find("velocidade parcial") > -1:
                if self.speed == 0.4:
                    self.msg.linear.x = self.msg.linear.x/2
                    self.msg.angular.z = self.msg.angular.z/2
                    self.speed = 0.2
            if seg.word.find("frente") > -1:
                self.msg.linear.x = self.speed
                self.msg.angular.z = 0
            elif seg.word.find("esquerda") > -1:
                if self.msg.linear.x != 0:
                    if self.msg.angular.z < self.speed:
                        self.msg.angular.z += 0.05
                else:
                    self.msg.angular.z = self.speed*2
            elif seg.word.find("direita") > -1:
                if self.msg.linear.x != 0:
                    if self.msg.angular.z > -self.speed:
                        self.msg.angular.z -= 0.05
                else:
                    self.msg.angular.z = -self.speed*2
            elif seg.word.find("volta") > -1:
                self.msg.linear.x = -self.speed
                self.msg.angular.z = 0
            elif seg.word.find("parar") > -1 or seg.word.find("halt") > -1:
                self.msg = Twist()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str,
        default='/home/alanpereira/catkin_ws/src/SpeechRecognition/cmusphinx-pt-br-5.2',
        help='''acoustic model path
        (default: /home/alanpereira/catkin_ws/src/SpeechRecognition/cmusphinx-pt-br-5.2)''')
    parser.add_argument('--lexicon', type=str,
        default='/home/alanpereira/catkin_ws/src/SpeechRecognition/src/voice_cmd.dic',
        help='''pronunciation dictionary
        (default: voice_cmd.dic)''')
    parser.add_argument('--kwlist', type=str,
        default='/home/alanpereira/catkin_ws/src/SpeechRecognition/src/voice_cmd.kwlist',
